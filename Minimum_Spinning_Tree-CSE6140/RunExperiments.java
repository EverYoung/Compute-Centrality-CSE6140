...
public class RunExperiments{
	public static void main(String[] args) throws IOException {
		...
		Graph G = ParseEdges.parseEdges(graph_file);
		//G.print();


		double startMST = System.nanoTime();
		int MSTweight = ComputeMST.computeMST(G);
